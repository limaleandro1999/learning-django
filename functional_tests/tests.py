...
class NewVisitorTest(StaticLiveServerTestCase):
  ...
  def test_multiple_users_can_start_lists_at_different_urls(self):
    ...
    ## We use a new browser session to make no information of Edith's is comming through from cookies etc
    self.setUp()
  ...
  def test_layout_and_styling(self):
    ...
    # She starts a new lists and sees the input is nicely centered there too
